    ...
    <el-form label-width="auto" ref="ruleFormRef" :model="datas" :rules="rules">
      ...
      <el-form-item>
        <el-button type="primary" @click="onSubmit(ruleFormRef)"
          >更新</el-button
        >
        <el-button type="default" @click="formatJson" @mousedown.prevent
          >格式化</el-button
        >
...
import { sessionCache } from "@/hooks/useSession.ts";
import ToolPop from "./components/ToolPop.vue";

const ruleFormRef = ref<FormInstance>();
// 接收 props
const props = defineProps({
  datas: { type: Object as PropType<any>, required: true },
