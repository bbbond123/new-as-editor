...
import type { IBaseResponse, IResponse } from "@/api/type.ts";
...
export const addWebsiteComponent = (
  data: IAddWebsiteComponentQueryParams
...
export const editWebsiteComponent = (
  data: IEditWebsiteComponentQueryParams
